...
# UNIT_RE now lives with the run-doc parser that consumes it (run_doc);
# re-exported so this module and snapshot_gui are unaffected.
from run_doc import UNIT_RE  # noqa: E402
...
# Run-doc parsing moved to run_doc.py so the web panels and the
# shared libs can parse a run doc without loading Tk. Re-exported
# here so this module and its importers are unaffected.
# See EMS_Tk_Extraction_Plan.md.
from run_doc import (          # noqa: E402
    _preserve_mtime, _restore_mtime, _TIME_SLOT_RE, _extract_time_slot,
    _parse_run_doc_entries, _yesterday_run_date, _run_date_from_msg_name,
    parse_run_doc, _merge_duplicate_jobs,
)
